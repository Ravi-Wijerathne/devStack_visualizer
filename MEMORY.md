...
- **Updated Python scripts for Tauri GUI (CLI → GUI migration)**
  ...
  - **Updated `README.md`:** Added "Helper Scripts" section documenting `check_env.py` (environment checker) and `run.py` (quick launcher) usage with examples.
  - **Affected files:** `scripts/check_env.py`, `scripts/run.py`, `README.md`, `MEMORY.md`
